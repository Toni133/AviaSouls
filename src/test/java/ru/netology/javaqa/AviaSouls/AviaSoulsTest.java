package ru.netology.javaqa.AviaSouls;
...
public class AviaSoulsTest {
    ...
    public void testSortTickets() {
        ...
        Ticket ticket5 = new Ticket("UFA", "SPB", 200, 4, 9);
        Ticket ticket6 = new Ticket("MSK", "SPB", 200, 6, 18);
    ...
    @Test
    public void testSampleOfOneTicket() {
        AviaSouls manager = new AviaSouls();
        Ticket ticket1 = new Ticket("MSK", "SPB", 200, 10, 12);
        Ticket ticket2 = new Ticket("MSK", "SPB", 100, 11, 14);
        Ticket ticket3 = new Ticket("MSK", "UFA", 200, 10, 16);
    ...
    @Test
    public void testOfNonexistentTicket() {
        AviaSouls manager = new AviaSouls();
        Ticket ticket1 = new Ticket("MSK", "SPB", 200, 10, 12);
        Ticket ticket2 = new Ticket("MSK", "SPB", 100, 11, 14);
        Ticket ticket3 = new Ticket("MSK", "UFA", 200, 10, 16);
